  ...
  switch (action.type) {
    ...
    case "ADD_TO_RENTALS":
      const matchRental = state.listings.map((listing) => {
        if (listing.user_id !== action.payload.user_id) return listing;
      });
      return {
        ...state,
    ...
    case "DELETE_LISTING":
      ...
      return {
        ...state,
        currentUser: { ...state.currentUser, listings: listingDel },
      };
    case "NEW_LISTING":
      return {
        ...state,
    ...
    case "CREATE_NEW_LISTING":
      return {
        ...
        currentUser: {
          ...state.currentUser,
          listings: [...state.currentUser.listings, action.payload],
        },
      };
    default:
      return state;
