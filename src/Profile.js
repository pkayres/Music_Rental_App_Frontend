                    ...
                    return (
                      <div>
                        <Card key={userListing.id}>
                          ...
                          <Button
                            floated="right"
                            onClick={() => this.removeListing(userListing)}
                            color="blue"
                          >
                            REMOVE LISTING
                          </Button>
            ...
            <Card.Group>
              {this.props.currentUser !== null
                ? this.props.userRentals.map((userRental) => {
                    return userRental.rent.user_id ===
                      this.props.currentUser.id ? (
                      <Card key={userRental.id}>
                        <Card.Content>
                          <Image
                            src={userRental.image}
                            floated="right"
                            size="small"
                          />
                          <Card.Header>
                            {userRental.instrument_name}
                          </Card.Header>
                          <Card.Description>
                            <Modal
                              trigger={
                                <Button
                                  color="red"
                                  onClick={() => this.handleOpen(userRental)}
                                >
                                  RETURN
                                </Button>
                              }
                            ...
                            >
                              <Header>
                                {" "}
                                {currentListing.instrument_name}{" "}
                              </Header>
