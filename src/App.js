      ...
      <Grid>
        ...
        <Grid.Row centered>
          <Switch>
            ...
            <Route
              path="/guitars"
              render={() => <CategoryCard category="guitars" />}
            />
            <Route
              path="/drums"
              render={() => <CategoryCard category="drums" />}
            />
            <Route
              path="/basses"
              render={() => <CategoryCard category="basses" />}
            />
            <Route
              path="/keyboards"
              render={() => <CategoryCard category="keyboards" />}
            />
            <Route
              path="/brass"
              render={() => <CategoryCard category="brass" />}
            />
